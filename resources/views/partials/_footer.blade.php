        ...
        <div class="row">
            <div class="col-sm-6 col-md-3">
                <div class="widget dark">
                    <img class="mt-5 mb-20" alt="" src="images/codel_logo.png">
                    <p>CODeL, Federal University of Technology, Minna, Gidan Kwano Campus, Minna, Nigeria</p>
                    <ul class="list-inline mt-5">
                        <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-theme-colored2 mr-5"></i> <a
                                class="text-gray" href="#">+234 803 308 8426</a> </li>
                        <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-colored2 mr-5"></i> <a
                                class="text-gray" href="#">codel@futminna.edu.ng</a> </li>
                        <li class="m-0 pl-10 pr-10"> <i class="fa fa-globe text-theme-colored2 mr-5"></i> <a
                                class="text-gray" href="#">wwww.codel.futminna.edu.ng</a> </li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6 col-md-3">
